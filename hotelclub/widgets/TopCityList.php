 ...
 *
 * @category   HotelClub
 * @package    HotelClub_Widget_TopCityList
 * @subpackage PHP
 * @copyright  Copyright (c) 2010 HotelClub Pty Ltd (http://www.hotelclub.com)
 * @license    http://www.gnu.org/licenses/gpl-3.0.txt    GNU GENERAL PUBLIC LICENSE
 * @version    SVN: $Id$
 */
class HotelClub_Widget_TopCityList extends WP_Widget
{
    /**
     * Constructor
     *
     * @return void
     */
    function HotelClub_Widget_TopCityList()
    {
        parent::WP_Widget(false, __('HotelClub Top City List', 'hotelclub'), array('description' => __('Display a list of links to top cities', 'hotelclub')));
    }
    ...
    function widget($args, $instance)
    {
        ...
        include WP_PLUGIN_DIR . '/hotelclub/themes/' . get_option('hotelclub_theme') . '/TopCityList.php';
    }
    ...
    function form($instance)
    {
        ...
        include WP_PLUGIN_DIR . '/hotelclub/forms/TopCityList.php';
    }
}